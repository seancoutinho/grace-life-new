                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6">
                        <div className="wpo-section-title">
                            <span>We Love To Help People in Need</span>
                            <h2>Our Featured Campaigns</h2>
                            <p>Gracelife Foundation consistently runs important fundraising campaigns, and your contribution would be immensely valuable in supporting our initiatives.</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div className="wpo-campaign-content">
                                        <div className="wpo-campaign-text-top">
                                            ...
                                            <div className="campaign-btn">
                                                <ul>
                                                    <li>
                                                        <Image src={Cause.authorImg} alt=""/>
                                                        <span><Link onClick={ClickHandler} href="/cause-single/[slug]" as={`/cause-single/${Cause.slug}`}></Link></span>
                                                    </li>
