...
const Causes = [
    {
        ...
        process:'5',
        thumb:'Empowerment',
        cTitle: 'Greenhouse Projects',
        slug:'green-house-donations', 
        Goal:'20,000.00',
        Raised:'1,000.00',
        authorImg:author,
        dec: 'The ongoing greenhouse project at Highlands Community is meant to serve the community with sustainable resources for food security. ',
        fullDec: {
            title1: "Empowering Communities Through Greenhouse Projects",
            description1: 'At Gracelife Foundation, we believe in making a tangible difference in the lives of communities we serve. Two endeavors that reflects our commitment to sustainability, self-reliance, and the well-being of underprivileged individuals are our greenhouse projects. Today, we are thrilled to share one success story of our greenhouse project at Chinyaradzo Children’s Home and our ambitious plans for the future.',
    ...
    },
    {
        ...
        process:'4.5',
        thumb:'Health',
        cTitle: 'Dandamera Clinic Maternity Ward', 
        ...
        fullDec: {
            title1: "Supporting Maternity Care: Dandamera Clinic's Quest for Critical Equipment",
            description1: 'At Gracelife Foundation, we are committed to improving healthcare access and ensuring that essential medical facilities have the resources they need to provide quality care. We are honored to share the story of Dandamera Clinic Maternity Ward, which has reached out to us for assistance in acquiring vital equipment to enhance their maternity services.',
            title2: "A Vital Healthcare Hub",
            description2: "Dandamera Clinic Maternity Ward is a crucial healthcare institution serving its local community with dedication and compassion. Over the years, they have been a lifeline for expectant mothers, offering vital prenatal care and safe childbirth services. Despite their unwavering commitment, Dandamera Clinic Maternity Ward faces a significant challenge. They are in dire need of critical equipment that is essential for providing optimal care to both expectant mothers and newborns. This deficit has spurred them to seek assistance and partner with Gracelife Foundation to bridge the gap.",
            title3: "The Missing Pieces",
            description3: 'Maternity wards play a pivotal role in ensuring safe childbirth and the well-being of mothers and infants. However, the absence of crucial equipment can hinder their ability to provide the best care possible. Dandamera Clinic Maternity Ward is currently facing shortages in vital equipment such as ultrasound machines, infant incubators, fetal heart monitors, and delivery beds. These missing pieces are essential for monitoring the health of both mothers and babies, ensuring safe deliveries, and responding effectively to any complications that may arise during childbirth. With these critical tools, the maternity ward can significantly enhance their capacity to provide life-saving care to those in need.',
            title4: "How You Can Make a Difference",
            description4: "Dandamera Clinic Maternity Ward's commitment to their community's well-being is unwavering, but they cannot bridge this gap alone. This is where you come in. Your support can make a world of difference in ensuring that mothers and newborns receive the care and attention they deserve. Gracelife Foundation is joining hands with Dandamera Clinic Maternity Ward to raise the necessary funds to acquire the missing equipment. We invite you to be a part of this mission, to stand with us in support of safe childbirth and maternal health. Your donations, no matter how small, can help acquire the vital equipment needed to save lives and ensure that mothers and their babies receive the care they deserve. Together, we can empower Dandamera Clinic Maternity Ward to continue their invaluable work in their community. Stay tuned for updates on our fundraising efforts and how you can contribute to this noble cause. Your generosity can bring hope and health to mothers and newborns, ensuring a brighter and healthier future for all. Join us in making a meaningful impact in the world of maternity care.",
            title5: "",
            description5: "",
        },
    },
