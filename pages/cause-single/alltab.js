...
import cmt1 from '/public/images/blog-details/comments-author/img-1.jpg'
import cmt2 from '/public/images/blog-details/comments-author/img-2.jpg'
import cmt3 from '/public/images/blog-details/comments-author/img-3.jpg'
                                ...
                                <div className="wpo-case-content">
                                    <div className="wpo-case-text-top">
                                        ...
                                        <div className="case-b-text">
                                            <h1>{CauseDetails?.fullDec.title1}</h1>
                                            <p>{CauseDetails?.fullDec.description1}</p>
                                            <h1>{CauseDetails?.fullDec.title2}</h1>
                                            <p>{CauseDetails?.fullDec.description2}</p>
                                            <h1>{CauseDetails?.fullDec.title3}</h1>
                                            <p>{CauseDetails?.fullDec.description3}</p>
                                            <h1>{CauseDetails?.fullDec.title4}</h1>
                                            <p>{CauseDetails?.fullDec.description4}</p>
                                            <h1>{CauseDetails?.fullDec.title5}</h1>
                                            <p>{CauseDetails?.fullDec.description5}</p>
                                        </div>
                                    </div>
                                </div>
                            </Col>
                                    ...
                                    <form onSubmit={SubmitHandler}>
                                        ...
                                        <div className="wpo-donations-details">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                                    <input type="text" className="form-control" name="Address" id="Adress" placeholder="Adress" />
                                                </div>
                                                ...
                                                <li className="comment even thread-even depth-1" id="comment-1">
                                                    <div id="div-comment-1">
                                                        <div className="comment-theme">
                                                            <div className="comment-image"><Image src={cmt1} alt=""/></div>
                                                        </div>
                                                            ...
                                                            <div className="comment-wrapper">
                                                                ...
                                                                <div className="comment-area">
                                                                    ...
                                                                    <div className="comments-reply">
                                                                        <Link className="comment-reply-link" href="/cause-single/Poor-Children"><i className="fa fa-reply" aria-hidden="true"></i><span> Reply</span></Link>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <ul className="children">
                                                        <li className="comment">
                                                            <div>
                                                                <div className="comment-theme">
                                                                    <div className="comment-image"><Image src={cmt2} alt=""/></div>
                                                                </div>
                                                                <div className="comment-main-area">
                                                                    <div className="comment-wrapper">
                                                                        <div className="comments-meta">
                                                                        ...
                                                                        <div className="comment-area">
                                                                            <p>I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, </p>
                                                                            <div className="comments-reply">
                                                                                <Link className="comment-reply-link" href="/cause-single/Poor-Children"><span><i className="fa fa-reply" aria-hidden="true"></i> Reply</span></Link>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <ul>
                                                                <li className="comment">
                                                                    <div>
                                                                        <div className="comment-theme">
                                                                            <div className="comment-image"><Image src={cmt3} alt=""/></div>
                                                                        </div>
                                                                        <div className="comment-main-area">
                                                                            <div className="comment-wrapper">
                                                                                <div className="comments-meta">
